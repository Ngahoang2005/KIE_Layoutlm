...
def main():
    ...
    class CustomTrainer(Trainer):
        ...
        def evaluate(self, *args, **kwargs):
            ...
            # ---- segment_context_gate ----
            if hasattr(model_for_stats, "get_segment_gate_value"):
                gate_val = model_for_stats.get_segment_gate_value()
                if gate_val is not None:
                    logger.info(f"[diagnostics] segment_context_gate = {gate_val:.4f}")
